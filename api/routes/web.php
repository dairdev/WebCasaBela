...
$router->group(['prefix' => 'api'], function () use ($router) {
    ...
    $router->delete('propertyFeatures/{id}', 'PropertyFeaturesController@destroy');
    ...
    $router->get('departments/{department_id}/provinces', 'DepartmentsController@getProvincesByDepartment');
    ...
    $router->get('provinces/{province_id}/districts', 'ProvincesController@getDistrictsByProvince');
    ...
    $router->get('propertytypes', 'PropertyTypesController@index');
