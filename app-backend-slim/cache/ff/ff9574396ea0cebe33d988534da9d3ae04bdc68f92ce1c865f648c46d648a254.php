...
/* index.html.twig */
class __TwigTemplate_c79d14ee9f207e33ae0e646a07a73c87b1881505f0b8c3d024b4bc1c7a1ffd8c extends Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10\">
          <div class=\"rounded overflow-hidden shadow-lg flex flex-col bg-white\" data-aos=\"flip-down\">
            ...
            <div class=\"px-6 py-3 flex flex-row items-center justify-between bg-gray-100\">
              <a href=\"propiedad.html\" class=\"block px-8 py-2 text-xs text-white bg-blue-600\">
          ...
          <div class=\"w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:py-20 lg:max-w-screen-xl\">
            <div class=\"mb-0 lg:max-w-lg lg:pr-8 xl:pr-6\" data-aos=\"zoom-in-right\">
              ...
              <p class=\"mb-5 text-base text-gray-700 md:text-lg md:text-center\">
                ¿Listo para dar el siguiente paso en tu búsqueda de la propiedad perfecta? ¡Contáctanos hoy mismo para empezar! Nuestro equipo amable y experimentado está aquí para responder a todas tus preguntas y ayudarte a encontrar la propiedad de tus sueños.
              </p>
              <div class=\"mb-10 text-center md:mb-16 lg:mb-20\">
                <a
                  href=\"/WebCasaBela/public/contacto.html\"
                  class=\"inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md md:w-auto bg-red-400 hover:bg-red-700 focus:shadow-outline focus:outline-none\"
                >
                  Contáctanos
                </a>
              </div>
...
";
    ...
    {
        return new Source("", "index.html.twig", "/home/dennix/Projects/CasaBela/WebCasaBela/app-backend-slim/templates/index.html.twig");
    }
}
